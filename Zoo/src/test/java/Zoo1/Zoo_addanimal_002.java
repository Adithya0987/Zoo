...
public class Zoo_addanimal_002 extends BaseTest{
	...
	Assert.assertEquals(ad.getCageNumber().getAttribute("value"), "70", "The Entered Data Is Not Macthing");
	Reporter.log("The Entered cage number  is Macthing",true);
	ad.getFeedNumber().sendKeys(ToReadData.fromPropertyFile("Feed"));
	Assert.assertEquals(ad.getFeedNumber().getAttribute("value"), "80", "The Entered Data Is Not Macthing");
	...
	ad.getAnimalD().sendKeys(ToReadData.fromPropertyFile("Animalchange"));
	Assert.assertEquals(ad.getAnimalD().getText(),"(Puppy)" , "Updation went Worng");
